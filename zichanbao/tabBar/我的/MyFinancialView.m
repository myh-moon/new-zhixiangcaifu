...
{
    if (!_dataList2) {
        _dataList2 = [NSArray arrayWithObjects:@"我的投资",@"我的预约",@"资金记录",@"渠道中介",@"回款计划",@"积分商城",@"认证管理",@"我的分享码",@"客服电话",@"退出登录", nil];
    }
    return _dataList2;
}
- (NSArray *)imageList
{
    if (!_imageList) {
        _imageList = [NSArray arrayWithObjects:@"namea",@"yuyue",@"namepricetagsa",@"qudaozhongjie",@"namerefresh",@"jifenduihuan",@"namecard",@"nameshare",@"namephone",@"namehelp",@"bended-arrow-right", nil];
    }
    return _imageList;
}
